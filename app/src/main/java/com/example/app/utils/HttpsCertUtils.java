...
public class HttpsCertUtils {
    ...
    public static SSLParams getSSLParams(String protocol, InputStream[] certificates, InputStream localCert, String password) {

        if (TextUtils.isEmpty(protocol) || (!protocol.equals(Protocol.SSL) && protocol.equals(Protocol.TLS))) {
            protocol = "SSL";
        }
