...
public class Parse {
    ...
    //ParseDelegate
    private static ParseDelegate parseDelegate;
    ...
    public static void setParseDelegate(ParseDelegate parseDelegate) {
        Parse.parseDelegate = parseDelegate;
    }

    public static ParseDelegate getParseDelegate() {
